...
library(skimr)
data <- read_csv("data/hourly_station_16-17.csv")
data <- data %>%
...
data <-  data %>%
  ...
  mutate(site = "Cuyama", sensor = "station", microsite = "site", lat = -119.6738, long = 34.942525) %>%
filter(!is.na(year))
...
skim(data)
#write_csv(data, "data/Cuyama_climate_2016-2017.csv")
